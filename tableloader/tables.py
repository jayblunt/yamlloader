...
def metadataCreator(schema):
    ...
    agtAgentTypes = sa.Table('agtAgentTypes', metadata,
                             sa.Column('agentTypeID', sa.INTEGER(), primary_key=True, nullable=False),
                             sa.Column('agentType', sa.VARCHAR(length=50)),
                             schema=schema
                             )

    agtAgents = sa.Table('agtAgents', metadata,
                         sa.Column('agentID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    agtResearchAgents = sa.Table('agtResearchAgents', metadata,
                                 sa.Column('agentID', sa.INTEGER(), primary_key=True, nullable=False),
                                 sa.Column('typeID', sa.INTEGER(), primary_key=True, nullable=False),
                                 schema=schema
                                 )

    certCerts = sa.Table('certCerts', metadata,
                         sa.Column('certID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    certMasteries = sa.Table('certMasteries', metadata,
                             sa.Column('certID', sa.INTEGER(), primary_key=True, nullable=False),
                             sa.Column('masteryLevel', sa.INTEGER(), primary_key=True, nullable=False),
                             sa.Column('typeID', sa.INTEGER(), primary_key=True, nullable=False),
                             schema=schema
                             )
    ...
    certSkills = sa.Table('certSkills', metadata,
                          sa.Column('certID', sa.INTEGER(), primary_key=True, nullable=False),
                          sa.Column('certLevelInt', sa.INTEGER(), primary_key=True, nullable=False),
                          sa.Column('certLevelText', sa.VARCHAR(length=8)),
                          sa.Column('skillID', sa.INTEGER(), primary_key=True, nullable=False),
                          sa.Column('skillLevel', sa.INTEGER(), primary_key=True, nullable=False),
                          schema=schema
                          )

    chrAncestries = sa.Table('chrAncestries', metadata,
                             sa.Column('ancestryID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    chrAttributes = sa.Table('chrAttributes', metadata,
                             sa.Column('attributeID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    chrBloodlines = sa.Table('chrBloodlines', metadata,
                             sa.Column('bloodlineID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    chrFactions = sa.Table('chrFactions', metadata,
                           sa.Column('factionID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    chrRaces = sa.Table('chrRaces', metadata,
                        sa.Column('raceID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    crpActivities = sa.Table('crpActivities', metadata,
                             sa.Column('activityID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    crpNPCCorporationDivisions = sa.Table('crpNPCCorporationDivisions', metadata,
                                          sa.Column('corporationID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    dgmAttributeCategories = sa.Table('dgmAttributeCategories', metadata,
                                      sa.Column('categoryID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    dgmEffects = sa.Table('dgmEffects', metadata,
                          sa.Column('effectID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    dgmExpressions = sa.Table('dgmExpressions', metadata,
                              sa.Column('expressionID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    dgmTypeAttributes = sa.Table('dgmTypeAttributes', metadata,
                                 sa.Column('typeID', sa.INTEGER(), primary_key=True, nullable=False),
                                 sa.Column('attributeID', sa.INTEGER(), primary_key=True, nullable=False, index=True),
    ...
    eveGraphics = sa.Table('eveGraphics', metadata,
                           sa.Column('graphicID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    eveIcons = sa.Table('eveIcons', metadata,
                        sa.Column('iconID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    eveUnits = sa.Table('eveUnits', metadata,
                        sa.Column('unitID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    industryActivity = sa.Table('industryActivity', metadata,
                                sa.Column('typeID', sa.INTEGER(), primary_key=True, nullable=False),
                                sa.Column('activityID', sa.INTEGER(), primary_key=True, nullable=False, index=True),
    ...
    industryActivityMaterials = sa.Table('industryActivityMaterials', metadata,
                                         sa.Column('activityID', sa.INTEGER(), primary_key=True, nullable=False),
                                         sa.Column('materialTypeID', sa.INTEGER(), primary_key=True, nullable=False),
                                         sa.Column('typeID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    industryActivityProbabilities = sa.Table('industryActivityProbabilities', metadata,
                                             sa.Column('activityID', sa.INTEGER(), primary_key=True, nullable=False),
                                             sa.Column('productTypeID', sa.INTEGER(), primary_key=True, nullable=False),
                                             sa.Column('typeID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    industryActivityProducts = sa.Table('industryActivityProducts', metadata,
                                        sa.Column('activityID', sa.INTEGER(), primary_key=True, nullable=False),
                                        sa.Column('productTypeID', sa.INTEGER(), index=True, primary_key=True, nullable=False),
                                        sa.Column('typeID', sa.INTEGER(), primary_key=True, nullable=False),
                                        sa.Column('quantity', sa.INTEGER()),
                                        schema=schema
                                        )
    ...
    invContrabandTypes = sa.Table('invContrabandTypes', metadata,
                                  sa.Column('factionID', sa.INTEGER(), primary_key=True, nullable=False),
                                  sa.Column('typeID', sa.INTEGER(), primary_key=True, nullable=False, index=True),
    ...
    invControlTowerResourcePurposes = sa.Table('invControlTowerResourcePurposes', metadata,
                                               sa.Column('purpose', sa.INTEGER(), primary_key=True, nullable=False),
                                               sa.Column('purposeText', sa.VARCHAR(length=100)),
                                               schema=schema
                                               )

    invControlTowerResources = sa.Table('invControlTowerResources', metadata,
                                        sa.Column('controlTowerTypeID', sa.INTEGER(), primary_key=True, nullable=False),
                                        sa.Column('resourceTypeID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    invFlags = sa.Table('invFlags', metadata,
                        sa.Column('flagID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    invGroups = sa.Table('invGroups', metadata,
                         sa.Column('groupID', sa.INTEGER(), primary_key=True, nullable=False),
                         sa.Column('categoryID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    invItems = sa.Table('invItems', metadata,
                        sa.Column('itemID', sa.INTEGER(), primary_key=True, nullable=False),
                        sa.Column('typeID', sa.INTEGER(), nullable=False),
                        sa.Column('ownerID', sa.INTEGER(), index=True, nullable=False),
                        sa.Column('locationID', sa.INTEGER(), index=True, nullable=False),
    ...
    invMarketGroups = sa.Table('invMarketGroups', metadata,
                               sa.Column('marketGroupID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    invMetaGroups = sa.Table('invMetaGroups', metadata,
                             sa.Column('metaGroupID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    invPositions = sa.Table('invPositions', metadata,
                            sa.Column('itemID', sa.INTEGER(), primary_key=True, nullable=False),
                            sa.Column('x', sa.FLOAT(), nullable=False, default=sa.text("'0'")),
                            sa.Column('y', sa.FLOAT(), nullable=False, default=sa.text("'0'")),
                            sa.Column('z', sa.FLOAT(), nullable=False, default=sa.text("'0'")),
    ...
    invTraits = sa.Table('invTraits', metadata,
                         sa.Column('traitID', sa.INTEGER(), primary_key=True, nullable=False),
                         sa.Column('typeID', sa.INTEGER()),
    ...
    invTypeMaterials = sa.Table('invTypeMaterials', metadata,
                                sa.Column('typeID', sa.INTEGER(), primary_key=True, nullable=False),
                                sa.Column('materialTypeID', sa.INTEGER(), primary_key=True, nullable=False),
                                sa.Column('quantity', sa.INTEGER(), nullable=False, default=sa.text("'0'")),
                                schema=schema
                                )

    invTypeReactions = sa.Table('invTypeReactions', metadata,
                                sa.Column('reactionTypeID', sa.INTEGER(), primary_key=True, nullable=False),
                                sa.Column('typeID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    mapCelestialStatistics = sa.Table('mapCelestialStatistics', metadata,
                                      sa.Column('celestialID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    # warning: the sequence matters because of some text sql queries in the code
    mapConstellationJumps = sa.Table('mapConstellationJumps', metadata,
                                     sa.Column('fromRegionID', sa.INTEGER()),
                                     sa.Column('fromConstellationID', sa.INTEGER(), primary_key=True, nullable=False),
                                     sa.Column('toConstellationID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    mapConstellations = sa.Table('mapConstellations', metadata,
                                 ...
                                 sa.Column('constellationID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    mapJumps = sa.Table('mapJumps', metadata,
                        sa.Column('stargateID', sa.INTEGER(), primary_key=True, nullable=False),
                        sa.Column('destinationID', sa.INTEGER()),
                        schema=schema
                        )

    mapLandmarks = sa.Table('mapLandmarks', metadata,
                            sa.Column('landmarkID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    mapLocationScenes = sa.Table('mapLocationScenes', metadata,
                                 sa.Column('locationID', sa.INTEGER(), primary_key=True, nullable=False),
                                 sa.Column('graphicID', sa.INTEGER()),
                                 schema=schema
                                 )
    ...
    mapRegionJumps = sa.Table('mapRegionJumps', metadata,
                              sa.Column('fromRegionID', sa.INTEGER(), primary_key=True, nullable=False),
                              sa.Column('toRegionID', sa.INTEGER(), primary_key=True, nullable=False),
                              schema=schema
                              )

    mapRegions = sa.Table('mapRegions', metadata,
                          sa.Column('regionID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    mapSolarSystemJumps = sa.Table('mapSolarSystemJumps', metadata,
                                   ...
                                   sa.Column('fromSolarSystemID', sa.INTEGER(), primary_key=True, nullable=False),
                                   sa.Column('toSolarSystemID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    mapSolarSystems = sa.Table('mapSolarSystems', metadata,
                               sa.Column('regionID', sa.INTEGER(), index=True),
                               sa.Column('constellationID', sa.INTEGER(), index=True),
                               sa.Column('solarSystemID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    mapUniverse = sa.Table('mapUniverse', metadata,
                           sa.Column('universeID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    planetSchematics = sa.Table('planetSchematics', metadata,
                                sa.Column('schematicID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    planetSchematicsPinMap = sa.Table('planetSchematicsPinMap', metadata,
                                      sa.Column('schematicID', sa.INTEGER(), primary_key=True, nullable=False),
                                      sa.Column('pinTypeID', sa.INTEGER(), primary_key=True, nullable=False),
                                      schema=schema
                                      )
    ...
    ramAssemblyLineStations = sa.Table('ramAssemblyLineStations', metadata,
                                       sa.Column('stationID', sa.INTEGER(), primary_key=True, nullable=False),
                                       sa.Column('assemblyLineTypeID', sa.INTEGER(), primary_key=True, nullable=False),
                                       sa.Column('quantity', sa.INTEGER()),
    ...
    ramInstallationTypeContents = sa.Table('ramInstallationTypeContents', metadata,
                                           sa.Column('installationTypeID', sa.INTEGER(), primary_key=True, nullable=False),
                                           sa.Column('assemblyLineTypeID', sa.INTEGER(), primary_key=True, nullable=False),
                                           sa.Column('quantity', sa.INTEGER()),
                                           schema=schema
                                           )
    ...
    skinLicense = sa.Table('skinLicense', metadata,
                           sa.Column('licenseTypeID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    skinMaterials = sa.Table('skinMaterials', metadata,
                             sa.Column('skinMaterialID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    skins = sa.Table('skins', metadata,
                     sa.Column('skinID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    staOperationServices = sa.Table('staOperationServices', metadata,
                                    sa.Column('operationID', sa.INTEGER(), primary_key=True, nullable=False),
                                    sa.Column('serviceID', sa.INTEGER(), primary_key=True, nullable=False),
                                    schema=schema
                                    )
    ...
    staStationTypes = sa.Table('staStationTypes', metadata,
                               sa.Column('stationTypeID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    staStations = sa.Table('staStations', metadata,
                           sa.Column('stationID', sa.BigInteger, primary_key=True, nullable=False),
                           sa.Column('security', sa.FLOAT(precision=53)),
    ...
    translationTables = sa.Table('translationTables', metadata,
                                 sa.Column('sourceTable', sa.VARCHAR(length=200), primary_key=True, nullable=False),
                                 sa.Column('destinationTable', sa.VARCHAR(length=200)),
                                 sa.Column('translatedKey', sa.VARCHAR(length=200), primary_key=True, nullable=False),
    ...
    trnTranslationColumns = sa.Table('trnTranslationColumns', metadata,
                                     sa.Column('tcGroupID', sa.INTEGER()),
                                     sa.Column('tcID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    trnTranslationLanguages = sa.Table('trnTranslationLanguages', metadata,
                                       sa.Column('numericLanguageID', sa.INTEGER(), primary_key=True, nullable=False),
    ...
    trnTranslations = sa.Table('trnTranslations', metadata,
                               ...
                               sa.Column('languageID', sa.VARCHAR(length=50), primary_key=True, nullable=False),
    ...
    warCombatZones = sa.Table('warCombatZones', metadata,
                              sa.Column('combatZoneID', sa.INTEGER(), primary_key=True, nullable=False),
